...
export default function V2() {
  return (
    <div className="max-w-3xl items-center mx-auto w-full py-16">
      <div>
        ...
        <div className="text-gray-300">
          ...
          and write code. I have 2 years of experience in full stack development
           and building projects from scratch. Reach out to me at{" "}
        ...
        <div className="flex flex-row gap-2">
          ...
          <div className="w-full">
            <div className="flex flex-row gap-2 justify-between">
              <div>
                <div className="text-white text-md font-semibold">NoScrubs</div>
            ...
            <ul className="ml- list-outside list-disc mt-2">
              ...
              <li>
                Developed and maintained core APIs in Ruby on Rails, supporting
        ...
        <div className="flex gap-2">
          <div className="flex flex-col gap-2">
            ...
            <ul className="list-disc ml-4">
              ...
              <div>
                Tech Stack: MERN, Socket.IO, Redis, Flask, Langchain, TypeScript{" "}
              </div>
            </ul>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <div className="flex flex-col gap-2">
            ...
            <ul className="list-disc ml-4">
              ...
              <li>
                Utilized nodemailer to use an SMTP server in JavaScript to send
        ...
        <div className="flex gap-2">
          <div className="flex flex-col gap-2">
            ...
            <ul className="list-disc ml-4">
              ...
              <li>
                Parses multipart part form data including images coming from raw
                http request in nodejs
              </li>
            </ul>
          </div>
        </div>
